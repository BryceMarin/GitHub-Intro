...
# Note: This is a clever little tool to change the spacing of the subplots
# plt.subplot_tool()
...
normal_colors = ["#4053d3", "#ddb310", "#00beff", "#fb49b0", "#00b25d", "#cacaca"]
# sharex allows you to keep one x-axis for both graphs
...
fig.supylabel("Billions of Constant 2023 U.S. Dollars", x = 0.07)
...
plt.figtext(0.02, 0.02, "Source: SIPRI Military Expenditure Database", fontsize = 8, ha = "left")
